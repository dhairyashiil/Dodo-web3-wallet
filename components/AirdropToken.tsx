...
export default function AirdropToken() {
  ...
  return (
    <div className="flex justify-center">
      <div className="text-black text-sm bg-white p-5 m-5 rounded-lg w-[600px] ">
        <div className="space-y-4">
          <div>
            <label className="block text-gray-700 mb-2">RPC Provider</label>
            <select
          ...
          <div>
            <label className="block text-gray-700 mb-2">Amount (in SOL)</label>
            <input
              type="number"
        ...
        {success && (
          <Link href={signLink}>
            <div className="mt-4 p-3 bg-green-100 text-green-700 rounded-lg text-sm flex items-center gap-2 hover:underline">
