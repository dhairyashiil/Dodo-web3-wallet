...
export function DraggableCardDemo() {
  ...
  return (
    <DraggableCardContainer className="relative flex min-h-screen w-full items-center justify-center overflow-clip">
      <p className="absolute mx-auto max-w-sm -translate-y-3/4 text-center text-sm font-black text-neutral-400 md:text-md dark:text-neutral-800">
        This NFT is shown for example purposes only. We do not own it. All
        rights belong to the original owner/creator.
      </p>
