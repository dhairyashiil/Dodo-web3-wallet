...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        'relative w-[82rem] overflow-hidden rounded-lg border border-white/[0.08] bg-[#1d1c20] p-8',
        className
      )}
    >
      {children}
      ...
      <div className="relative flex h-20 items-center overflow-hidden">
        ...
        >
          <p
            ...
            className="bg-gradient-to-b from-white to-neutral-300 bg-clip-text py-10 text-base font-bold text-transparent text-white sm:text-[1.5rem]"
          >
            {revealText}
          </p>
        </motion.div>
        ...
        <div className="overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="bg-[#323238] bg-clip-text py-10 text-base font-bold text-transparent sm:text-[1.5rem]">
            {text}
          </p>
          <MemoizedStars />
        </div>
